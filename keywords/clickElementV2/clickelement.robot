...
Click Camera At Center
    ...
    Click Elements    xpath=//android.widget.TextView[@content-desc="Camera"]    0.5    0.5
    Close session
...
Click Camera At Top Left
    ...
    Start session
    Wait Until Element Is Visible    xpath=//android.widget.TextView[@content-desc="Camera"]    5s
    Click Elements    xpath=//android.widget.TextView[@content-desc="Camera"]    0    0
    Close session
...
Click Camera At Absolute Offset
    ...
    Start session
    Wait Until Element Is Visible    xpath=//android.widget.TextView[@content-desc="Camera"]    5s
    Click Elements    xpath=//android.widget.TextView[@content-desc="Camera"]    10    20
    Close session
...
Click Calculator Button 8 At Center
    ...
    Click Elements    id=com.google.android.calculator:id/digit_8    0.5    0.5
    Close session
...
ClickC Element Not Found - Fixed
    [Tags]    error    locator
    Start session
    Run Keyword And Expect Error    ValueError: Element with locator*    Click Elements    xpath=//android.widget.TextView[@content-desc="NaoExiste"]    10    20
    Close session
...
ClickC Coordinates Out Of Bounds - Fixed
    ...
    Start session
    Wait Until Element Is Visible    xpath=//android.widget.TextView[@content-desc="Camera"]    5s
    Run Keyword And Expect Error    ValueError: Coordinates*out of device screen bounds*    Click Elements    xpath=//android.widget.TextView[@content-desc="Camera"]    200    200
    Close session
...
ClickC Invalid Offset Type - Fixed
    ...
    Start session 1
    Wait Until Element Is Visible    id=com.google.android.calculator:id/digit_8    5s
    Run Keyword And Expect Error    ValueError: xoffset and yoffset must be numbers*    Click Elements    id=com.google.android.calculator:id/digit_8    abc    def
    Close session
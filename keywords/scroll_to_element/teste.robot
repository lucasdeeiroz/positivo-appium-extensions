...
Deve encontrar o elemento selecionado
    ...
    Scroll Element Into View    //android.widget.TextView[@resource-id="com.samsung.android.app.notes:id/title" and @text="‎Sol_Ingenieria_Mecanica_ESTATICA_R_C_Hib"]    
    Capture Page Screenshot
    Sleep    5
    Scroll To Element    container_locator=//android.widget.GridView[@resource-id="com.samsung.android.app.notes:id/noteslist_recyclerview"]
...
Deve encontrar o ano selecionado
    ...
    Scroll To Element    container_locator=com.samsung.android.calendar:id/year_pager
...
Deve encontrar o elemento de formatação no Google Docs partindo da Tela Inicial
    ...
    Press Keycode    3
    Scroll To Element    locator=//android.widget.TextView[@content-desc="Teste SwipeIntoElement"]
    ...
    Wait Until Element Is Visible    //android.widget.CompoundButton[@content-desc="Formatar"]    30
    Click Element    //android.widget.CompoundButton[@content-desc="Formatar"]
    
    Wait Until Element Is Visible    //android.widget.LinearLayout[@resource-id="com.google.android.apps.docs.editors.docs:id/btn_show_font_family"]    30
    Click Element    //android.widget.LinearLayout[@resource-id="com.google.android.apps.docs.editors.docs:id/btn_show_font_family"]
    
    Scroll To Element    locator=//android.widget.Button[@resource-id="com.google.android.apps.docs.editors.docs:id/btn_clear_formatting"]

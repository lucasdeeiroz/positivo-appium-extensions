    ...
    def perform_zoom_in_gesture(self, locator, scale=1.5, duration=500, direction="vertical", pause_s=0.1, steps=50):
        ...
        try:
            ...
            for i in range(1, steps + 1):
                ...
                interp_f1_x = f1_start[0] + t * (f1_end[0] - f1_start[0]) + random.uniform(-1, 1)
                interp_f1_y = f1_start[1] + t * (f1_end[1] - f1_start[1]) + random.uniform(-1, 1)
                interp_f2_x = f2_start[0] + t * (f2_end[0] - f2_start[0]) + random.uniform(-1, 1)
                interp_f2_y = f2_start[1] + t * (f2_end[1] - f2_start[1]) + random.uniform(-1, 1)
